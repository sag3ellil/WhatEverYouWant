...
export class ObjectDetailsComponent implements OnInit {
  ...
  itemDetails:ItemDetails = {id: 1,
  name: "car bmw 110",
  status:  "active",
  phone: 22875402,
  location: "avenue habib borguiba 5",
  date: "15/07/2024",
  ownerName: "Mounir",
 ...
 item:any;
  ngOnInit(): void {
   ...
   const objectId = parseInt(this.route.snapshot.params['id'], 10);
  ...
  private initializeMap(leaflet: any) {
    ...
    //navigator.geolocation.getCurrentPosition((position) => {
      const lat = 50.872204302192415;
      const lng = 4.4041476680286;
  ...
  componentId!:string
  goBack(): void {
    this.componentId=this.commonService.dashbordComponentID
    this.router.navigate(["/",this.componentId]);
  }
}
